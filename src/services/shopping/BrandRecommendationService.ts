...
export const STRATEGY_META: Record<PurchaseStrategy, StrategyMeta> = {
  economic: {
    label: 'Opciones Inteligentes',
    description: 'Opciones convenientes en mercado, tianguis y supermercado con excelente frescura y rendimiento.',
    emoji: '🛒',
    color: '#14532d',
    bgColor: '#dcfce7',
    borderColor: '#86efac',
  ...
  value: {
    label: 'Marcas del Supermercado',
    description: 'Marcas confiables y de alta disponibilidad con excelente calidad nutricional.',
    emoji: '🛒',
    color: '#1e3a8a',
    bgColor: '#dbeafe',
    borderColor: '#93c5fd',
  ...
  premium: {
    ...
    description: 'Productos de origen controlado, reducidos en aditivos y de alta densidad nutricional.',
    emoji: '⭐',
    color: '#4c1d95',
    bgColor: '#ede9fe',
    borderColor: '#c4b5fd',
  ...
  neutral: {
    ...
    description: 'Sugerencias generales para una alimentación balanceada y saludable.',
    emoji: '🌿',
    color: '#374151',
    bgColor: '#f3f4f6',
    borderColor: '#d1d5db',
